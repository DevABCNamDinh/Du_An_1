...
public partial class CsdlDuAn1NewNew2Context : DbContext
{
    public CsdlDuAn1NewNew2Context()
    {
    }

    public CsdlDuAn1NewNew2Context(DbContextOptions<CsdlDuAn1NewNew2Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-6F71DIH\\SQLEXPRESS;Database=CSDL_DuAn_1_NewNew2;Trusted_Connection=True;TrustServerCertificate=true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ChucVu>(entity =>
        {
            entity.HasKey(e => e.IdchucVu).HasName("PK__ChucVu__70FCCF6551D9E540");
        ...
        {
            entity.HasKey(e => e.IdhoaDon).HasName("PK__HoaDon__5B896F4911A47F76");
        ...
        {
            entity.HasKey(e => e.IdhoaDonChiTiet).HasName("PK__HoaDonCh__21C2367710F4389E");
            ...
            entity.HasOne(d => d.IdhoaDonNavigation).WithMany(p => p.HoaDonChiTiets)
                ...
                .HasConstraintName("FK__HoaDonChi__IDHoa__656C112C");

            entity.HasOne(d => d.IdsanPhamNavigation).WithMany(p => p.HoaDonChiTiets)
                .HasForeignKey(d => d.IdsanPham)
                .HasConstraintName("FK__HoaDonChi__IDSan__66603565");
        });

        modelBuilder.Entity<KhachHang>(entity =>
        {
            entity.HasKey(e => e.IdkhachHang).HasName("PK__KhachHan__5A7167B55EAC500A");
        ...
        {
            entity.HasKey(e => e.IdkhuyenMai).HasName("PK__KhuyenMa__FFAC1400D756A21D");
        ...
        {
            entity.HasKey(e => e.IdloaiSanPham).HasName("PK__LoaiSanP__6CB987C54E81458F");
        ...
        {
            entity.HasKey(e => e.IdnhanVien).HasName("PK__NhanVien__7AC2D9F73E462326");
        ...
        {
            entity.HasKey(e => e.IdsanPham).HasName("PK__SanPham__9D45E58AD96653F0");
            ...
            entity.HasOne(d => d.IdloaiSanPhamNavigation).WithMany(p => p.SanPhams)
                ...
                .HasConstraintName("FK__SanPham__IDLoaiS__628FA481");
        });

        modelBuilder.Entity<ThanhTien>(entity =>
        {
            entity.HasKey(e => e.IdthanhTien).HasName("PK__ThanhTie__34C64E6864F5ED99");
            ...
            entity.HasOne(d => d.IdhoaDonNavigation).WithMany(p => p.ThanhTiens)
                .HasForeignKey(d => d.IdhoaDon)
                .HasConstraintName("FK__ThanhTien__IDHoa__5FB337D6");
        });
